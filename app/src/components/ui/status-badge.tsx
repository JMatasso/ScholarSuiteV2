...
const statusConfig = {
  ...
  // Student statuses
  NEW: { label: "New", color: "bg-accent text-blue-700 ring-blue-300" },
  ...
  INACTIVE: { label: "Inactive", color: "bg-muted text-foreground ring-gray-300" },
  GRADUATED: { label: "Graduated", color: "bg-purple-50 text-purple-700 ring-purple-300" },

  // Document / workflow statuses
  DRAFT: { label: "Draft", color: "bg-muted text-foreground ring-gray-300" },
  UNDER_REVIEW: { label: "Under Review", color: "bg-accent text-blue-700 ring-blue-300" },
  APPROVED: { label: "Approved", color: "bg-green-50 text-green-700 ring-green-300" },

  // Ticket / issue statuses
  OPEN: { label: "Open", color: "bg-accent text-blue-700 ring-blue-300" },
  RESOLVED: { label: "Resolved", color: "bg-green-50 text-green-700 ring-green-300" },

  // Priority levels
  LOW: { label: "Low", color: "bg-muted text-foreground ring-gray-300" },
