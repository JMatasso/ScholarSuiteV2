...
const alertToastVariants = cva(
  "relative w-full max-w-sm overflow-hidden rounded-lg shadow-lg flex items-start p-4 space-x-4",
  {
    ...
    compoundVariants: [
      { variant: "success", styleVariant: "default", className: "text-success-foreground border-green-200 dark:border-green-700" },
      { variant: "warning", styleVariant: "default", className: "text-warning-foreground border-yellow-200 dark:border-yellow-700" },
      { variant: "info", styleVariant: "default", className: "text-info-foreground border-blue-200 dark:border-blue-700" },
      { variant: "error", styleVariant: "default", className: "text-destructive-foreground border-red-200 dark:border-red-700" },
      ...
      { variant: "info", styleVariant: "filled", className: "bg-info text-info-foreground" },
