    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-semibold text-secondary-foreground">Privacy Policy</h1>
        ...
        <div className="prose prose-sm max-w-none text-foreground space-y-6">
          <section>
            <h2 className="text-lg font-semibold text-secondary-foreground">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-secondary-foreground">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-secondary-foreground">3. Information Sharing</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-secondary-foreground">4. Data Security</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-secondary-foreground">5. Your Rights</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-secondary-foreground">6. Data Retention</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-secondary-foreground">7. Children&apos;s Privacy</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-secondary-foreground">8. Changes to This Policy</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-secondary-foreground">9. Contact Us</h2>
