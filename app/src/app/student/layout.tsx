      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-16 shrink-0 items-center justify-between border-b border-border bg-card px-4 lg:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Messages */}
            <Link href="/student/messages" className="relative flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-muted-foreground hover:bg-muted hover:text-foreground transition-colors">
            ...
            {/* Meetings */}
            <Link href="/student/meetings" className="flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-muted-foreground hover:bg-muted hover:text-foreground transition-colors">
